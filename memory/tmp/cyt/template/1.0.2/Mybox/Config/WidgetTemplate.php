<?php /* /home/mong/project/memory/template/Mybox/Config/Widget.tpl */ class Mybox_Config_WidgetTemplate extends Podo_Template_Base { const HAVE_CDATA = FALSE; public function printHead($p_intLine, $p_intCol) { ?><?php $this->_tpl_2 = Podo_Template::instance('Common_Html'); foreach ($this as $__key=>$__val) { $this->_tpl_2->{$__key} = $__val; } $this->_tpl_2->printHead(-1, -1); ?>
						    ...
						    <br />
						    	<div id="copy_widget" style="display:none">
						    		...
						    		<br />
						    			<table>
						    				<tr>
						    					<td colspan="2"><textarea id="widget_cd" name="widget_cd" cols="40" rows="4" readonly="readonly"></textarea>
						    					</td>
						    				</tr>
						    				<tr>
						    					<td align="left">
