<?php /* /home/mong/project/memory/template/Mybox/Config/CyImage.tpl */ class Mybox_Config_CyImageTemplate extends Podo_Template_Base { const HAVE_CDATA = FALSE; public $myUser; public function printHead($p_intLine, $p_intCol) { ?><?php $this->_tpl_2 = Podo_Template::instance('Common_Html'); foreach ($this as $__key=>$__val) { $this->_tpl_2->{$__key} = $__val; } $this->_tpl_2->printHead(-1, -1); ?>
...
<?php $this->_tpl_23 = Podo_Template::instance('Common_Body'); foreach ($this as $__key=>$__val) { $this->_tpl_23->{$__key} = $__val; } $this->_tpl_23->printHead(-1, -1); ?>
	...
	<form name="imgForm" action="http://memory.nate.com/mybox/config/basicImgUp" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="tid" value="<?php echo $this->_escapeAttrib($this->myUser->cyworld->getcyId()); ?>" />
		...
		<div class="upload-wrap upload-photo">
			...
			<script type="text/javascript">
				objCyimage("cyimg7", "MinihompyPhoto", "580;400;350;300;250;200;140","500", "500", "500","<?php echo $this->myUser->cyworld->getcyId(); ?>","www.cyworld.com","","400")
			</script>
			<!-- 등록 버튼 -->
...
<?php $this->_tpl_23->printTail(-1, -1); unset($this->_tpl_23); ?>
