...
intDateadd=2 '날짜 증감변수 값 초기화 오늘기준
ArrQuery = array("AfterTo") '쿼리 변수
...
<body bgcolor="#F5F5F5" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('../enter/images/map_today_on.gif','../enter/images/map_tomorrow_on.gif')">
<!--서울 레이어 시작-->
    ...
    <tr> 
      <td bgcolor="#b4b4b4"> 
        <table width="42" border="0" cellspacing="1" cellpadding="0">
          <tr> 
            <td class="table09" height="34"><a href="../enter/weather/weather_land.asp"><img src="../enter/images/new<% =FnWeatherIcon(rsland("overview")) %>.gif"  alt='<% =rsland("overview") %>' height="34" border="0" onClick="top.leftFrame.location.href('../enter/leftmenu/left_menu_weather.asp')"></a></td>
          </tr>
          <tr> 
        ...
        <tr> 
		  ...
		  <!--오늘의 날씨/내일의 날씨/모레의 날씨 전체테이블 시작--> 
            <table width="290" border="0" cellspacing="0" cellpadding="0">
              <tr> 
				...
				<!--오늘의 날씨/내일의 날씨/모레의 날씨 탭 시작--> 
                  <table width="290" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td><a href="../enter/main_today.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image143','','../enter/images/map_today_on.gif',1)"><img name="Image143" border="0" src="../enter/images/map_today.gif" width="96" height="23"></a></td>
                      <td><a href="../enter/main_tomorrow.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image144','','../enter/images/map_tomorrow_on.gif',1)"><img name="Image144" border="0" src="../enter/images/map_tomorrow.gif" width="98" height="23"></a></td>
                      <td><img src="../enter/images/map_after_tomorrow_on.gif" width="96" height="23"></td>
                    </tr>
                  </table>
              ...
              <tr> 
                <td><img src="../enter/images/after_tomorrow_map.gif" width="290" height="322"></td>
              </tr>
            </table>
