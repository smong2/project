...
Dim rs, rsfirst, rsidlist '레코드셋 로그인 정보, 처음 로그인했는지 확인, 수요예측 서버에 등록되었는지 확인
dim intI,varInsert '증가변수
Dim VarId, VarPwd '아이디, 패스워드 사용자 입력값

varinsert=Request.Form("varinsert") '폼이 실행되었는지..

IF varinsert="ok" THEN '값을 입력하고 확인을 눌렀을 때 
varID=Request.Form("txtID")
varPWD=Request.Form("txtPWD") 

ArrQuery = array("TLOGIN",varID,varPWD) '페이지에 맞는 코드 가져오고  TLOGIN : 입장-로그인
...
IF NOT rsfirst.eof THEN	 '처음 방문했을 경우
  ...
  Response.Write "<script language=javascript>location.href('../enter/admin/admin_acnt_add.asp?varID=" & rsfirst(0) & "&varNAME=" & rsfirst(1) & "')</script>"
END IF
...
<body bgcolor="#FFFFFF" text="#000000" background="../enter/images/bg.gif" onload=document.form.txtID.focus() onload>
      ...
      <table width="496" border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <!--로그인 테두리 시작-->
            <table width="496" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><img src="../enter/images/login_round_edge1.gif" width="23" height="23"></td>
				<td><img src="../enter/images/login_round_top.gif" width="450" height="23"></td>
                <td><img src="../enter/images/login_round_edge2.gif" width="23" height="23"></td>
              </tr>
              <tr>
                <td><img src="../enter/images/login_round_left.gif" width="23" height="269"></td>
                <td>
				<!--로그인 내용 테이블 시작-->
                  <table width="450" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="../enter/images/login_main_img.gif" width="450" height="104"></td>
                    </tr>
                    <tr>
                            ...
                            <tr> 
                              ...
                              <td> 
                                ...
                                <table width="98" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    <td class="table03"><input type=image src="../enter/images/login_confirm_button.gif" width="46" height="46" border="0"></td>
                                    <td width="6"></td>
                                    <td class="table03"><img src="../enter/images/login_cancel_button.gif" width="46" height="46" border="0" onclick=history.go(-1)></td>
                                  </tr>
                                </table>
                                <!--확인/취소 버튼 끝-->
                              </td>
                    ...
                    <tr>
                      <td><img src="../enter/images/login_line_img.gif" width="450" height="1"></td>
                    </tr>
                    <tr>
					  ...
					  <!--아이디/패스워드 확인 시작-->
                        <table width="450" border="0" cellspacing="0" cellpadding="0">
                          <tr>
						  <td width="307"></td>
                            <td width="23" align="center"><img src="../enter/images/login_arrow_icon.gif" width="13" height="13"></td>
                            <td width="120" class="list09"><a href="#" onclick="window.open('../enter/pop_id_find.asp','idfind','width=346,height=249,left=100,top=200')">ID/Password 
                              확인</a></td>
                          </tr>
                        </table>
						<!--아이디/패스워드 확인 끝-->
                ...
                <td><img src="../enter/images/login_round_right.gif" width="23" height="269"></td>
              </tr>
              <tr>
                <td><img src="../enter/images/login_round_edge3.gif" width="23" height="23"></td>
                <td><img src="../enter/images/login_round_bottom.gif" width="450" height="23"></td>
                <td><img src="../enter/images/login_round_edge4.gif" width="23" height="23"></td>
              </tr>
            </table>
			<!--로그인 테두리 끝-->
          </td>
