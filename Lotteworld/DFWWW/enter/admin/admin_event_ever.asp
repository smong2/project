...
<% 
' ========================================================================================================
' 프로그램ID : TXBBULLETIN - ever admin
' 업  무  명 : 수요예측
' 프로그램명 : 롯데월드 입장객 예측 행사 - 에버랜드 행사 관리자
' 최초작성일 : 2002/10/16
' 최종작성일 : 2002/10/18
' 개  발  자 : 박순몽(kweather)
' ========================================================================================================
...
Dim rs,rsmodify '레코드셋 : 리스트, 수정시 수정 내용
...
IF hidinsert="ok" THEN
	varTitle=Request.Form("txtSubject") '폼으로 넘어온 변수들(입력,수정시 사용) - 주제
	varContents=Request.Form("txtaMemo") '글 내용
	hidIdx=Request.Form("hidIdx") '수정시
...
ArrQ = array(varMode,intIdx,"에버랜드") '수정 보기 쿼리
'여기까지
...
IF varMode="MQ" THEN '수정시 글번호 가져옴
'두번째 레코드셋을 어레이로 변환
...
<body bgcolor="#F5F5F5" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="MM_preloadImages('../../enter/images/tap_lotte2.gif','../../enter/images/tap_seoul2.gif');Fn_clearModify();document.form.txtSubject.focus()" >
<form method=post action='admin_event_ever.asp' name=form>
      ...
      <table width="642" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="title_01_c"><img src="../../enter/images/yellowgreen_buret.gif" width="7" height="7"> 
                  ...
                  <select name="sltParkClass">
                    ...
                    <option value=에버랜드 selected>에버랜드</option>
                    <option value=서울랜드>서울랜드</option>
                  </select>
                </td>
              </tr>
            </table>
		  ...
		  <!--롯데월드/에버랜드/서울랜드 행사정보게시판 롤오버 탭 시작-->
            <table width="217" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><img src="../../enter/images/tab_ever.gif" width="72" height="24"></td>
                <td><a href="admin_event_seoul.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image41','','../../enter/images/tab_seoul.gif',1)"><img name="Image41" border="0" src="../../enter/images/tab_seoul2.gif" width="72" height="24"></a></td>
              </tr>
            </table>
        ...
        <tr valign="top"> 
		  ...
		  <!--에버랜드 행사정보 게시판 시작-->
                  <table width="642" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td><img src="../../enter/images/gray_edge1.gif" width="15" height="15"></td>
                      <td bgcolor="#F4F4F4">
					  <!--게시판 박스 상단 테이블 시작--> 
                        <table width="612" border="0" cellspacing="0" cellpadding="0" height="15">
                          <tr> 
                            <td width="57" background="../../enter/images/gray_round_edge_top.gif"></td>
                            <td width="72"></td>
                            <td width="483" background="../../enter/images/gray_round_edge_top.gif"></td>
                          </tr>
                        </table>
						<!--게시판 박스 상단 테이블 끝-->
                      </td>
					  ...
					  <!--게시판 목록 시작--> 
                        <table width="523" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            ...
                            <td width="316" class="list05"><a href="../../enter/event/event_ever_view.asp?intIdx=<% =rs("IDX") %>" title='<% =rs("TITLE") %>'><% =left(rs("TITLE"),34) %>...</a></td>
                            <td width="107" align="right"><img src="../../enter/images/modIFy_small_bu.gif" width="52" height="13" onclick="location.href('admin_event_ever.asp?intIdx=<%=rs("Idx") %>&varMode=MQ')"></td>
                            <td width="60" align="right"><img src="../../enter/images/delete_small_bu.gif" width="52" height="13" onclick="location.href('admin_event_delete.asp?code=ever&intIdx=<%=rs("Idx") %>')"></td>
                          </tr>
                          <tr> 
							...
							<!--페이지 번호 테이블 시작--> 
                              ...
                              <td width="64" class="list13_1"> 
                                <%	IF intCurPage >1 THEN
										Response.Write "<a href='admin_event_ever.asp?intPage=" & intCurPage-1 & "'>◀ 이전</a>"
									ELSE
                              ...
                              <td width="140" class="list14_1"> 
								...
								<%	FOR intI=intStartPage to intStartPage-1+intLimit
										Response.Write "<a href='admin_event_ever.asp?intPage=" & intI & "'>" & intI & "</a> "
                              ...
                              <td width="64" class="list13_2"> 
                                <%	IF intCurPage - intLastPage <0 THEN
										Response.Write "<a href='admin_event_ever.asp?intPage=" & intCurpage+1 & "'>다음 ▶</a>"
									ELSE
