...
Dim txtID, txtPASSWD, txtREPASSWD, txtMOBILE, txtTEL, txtDEPT, sltAUTHLEVEL '사용자가 수정한 값
DIM TxtDelete '옵션값
...
IF varAuthlevel<>2 AND varAuthlevel<>7 AND varID<>Request.Cookies("ckID") THEN '계정 수정 권한 설정
...
sltAUTHLEVEL=Request.Form("sltAUTHLEVEL") '권한
 ...
 IF varNAME="" THEN varNAME="1" '대체값 설정
		  ...
		  <!--수정 테이블 시작--> 
            <table width="642" border="0" cellspacing="1" cellpadding="7">
              ...
              <tr> 
                ...
                <option value=1 selected>입장객 일반</option>
                <option value=2>입장객 관리</option>                
                <option value=5>잠긴 계정</option>                
                </select>                 
                <% ELSEIF rs("Authlevel")=2 THEN %>
                <select name=sltAuthlevel>
                <option value=1>입장객 일반</option>
                <option value=2 selected>입장객 관리</option>                                
                <option value=5>잠긴 계정</option>
                </select>                 
                ...
                <option value=1>입장객 일반</option>
                <option value=2>입장객 관리</option>                                
                <option value=5 selected>잠긴 계정</option>
                </select>                                         
                <% END IF %>
