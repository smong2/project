...
'변수의 선언
Dim ArrRValue, ArrRvalueUI, objServerQ, objServerUI, Arr '컴관련 변수들
...
IF hidinsert="ok" THEN
	...
	intStartYear=Request.Form("sltStartyear") '각변수들 행사 시작일
	intStartMonth=Request.Form("sltStartmonth")  '행사 시작월
	intStartDay=Request.Form("sltStartday") '행사 시작일
	intEndYear=Request.Form("sltEndyear") '행사 종료 년
	intEndMonth=Request.Form("sltEndmonth") '행사 종료 월
	intEndDay=Request.Form("sltEndday") '행사 종료 일
	dtStartDate=dateserial(intStartYear,intStartMonth,intStartDay) '시작일 날짜생성
	dtEndDate=dateserial(intEndYear,intEndMonth,intEndDay) '종료일 날짜생성
	varParkClass=Request.Form("sltParkClass") '파크구분
END IF
...
IF varMode="MQ" THEN '수정시에는 수정번호에 해당하는 레코드를 가져옴
'두번째 레코드셋을 어레이로 변환
...
<body bgcolor="#F5F5F5" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="MM_preloadImages('../../enter/images/tap_lotte2.gif','../../enter/images/tap_ever2.gif');Fn_clearModify();document.form.txtSubject.focus()" >
<form method=post action='admin_event_seoul.asp' name=form>
                          ...
                          <tr> 
							...
							<!--게시판 박스 상단 테이블 시작--> 
                              <table width="612" border="0" cellspacing="0" cellpadding="0" height="15">
                                <tr> 
                                  <td width="130" background="../../enter/images/gray_round_edge_top.gif"></td>
                                  <td width="72"></td>
                                  <td width="410" background="../../enter/images/gray_round_edge_top.gif"></td>
                                </tr>
                              </table>
							  <!--게시판 박스 상단 테이블 끝-->
                            </td>
                          ...
                          <tr> 
							...
							<!--게시판 목록 시작--> 
                              <table width="523" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr> 
                                  <td width="50" height="19" class="list12_1"><% =rs("IDX") %></td>
                                  <td width="316" class="list05"><a href="../../enter/event/event_seoul_view.asp?intIdx=<%=rs("IDX") %>" title='<% =rs("TITLE") %>'><%=left(rs("TITLE"),34) %>...</a></td>
                                  ...
                                  <td width="60" align="right"><img src="../../enter/images/delete_small_bu.gif" width="52" height="13" onclick="location.href('admin_event_delete.asp?intIdx=<%=rs("IDX") %>')"></td>
                                </tr>
                                <tr> 
