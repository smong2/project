...
<% 
' ========================================================================================================
' 프로그램ID : TXBBULLETIN - lotte admin
' 업  무  명 : 수요예측
' 프로그램명 : 롯데월드 입장객 예측 행사 - 롯데월드 행사 관리자
' 최초작성일 : 2002/10/16
' 최종작성일 : 2002/11/22
' 개  발  자 : 박순몽(kweather)
' ========================================================================================================
...
ArrQ = array(varMode,intIdx,"롯데월드") '수정 보기 쿼리
'여기까지
              ...
              <tr>
                <td class="title_01_c"><img src="../../enter/images/yellowgreen_buret.gif" width="7" height="7"> 
                  ...
                  <select name="sltParkClass">                                     
                    <option selected value=롯데월드>롯데월드</option>
        ...
        <tr>
		  ...
		  <!--롯데월드/에버랜드/서울랜드 행사정보게시판 롤오버 탭 시작-->
            <table width="217" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><img src="../../enter/images/tab_lotte.gif" width="73" height="24"></td>
                ...
                <td><a href="admin_event_seoul.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image42','','../../enter/images/tab_seoul.gif',1)"><img name="Image42" border="0" src="../../enter/images/tab_seoul2.gif" width="72" height="24"></a></td>
              </tr>
            </table>
				...
				<!--게시판 목록 시작--> 
                  <table width="523" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <td width="316" class="list05"><a href="../../enter/event/event_lotte_view.asp?intIdx=<% =rs("IDX") %>" title='<% =rs("TITLE") %>'><% =left(rs("title"),30) %>...</a></td>
                      <td width="107" align="right"><img src="../../enter/images/modIFy_small_bu.gif" width="52" height="13" onclick="location.href('admin_event_lotte.asp?intIdx=<%=rs("IDX") %>&varMode=MQ')"></td>
                      <td width="60" align="right"><img src="../../enter/images/delete_small_bu.gif" width="52" height="13"  onclick="location.href('admin_event_delete.asp?code=lotte&intIdx=<%=rs("IDX") %>')"></td>
                    </tr>
                    <tr> 
                          ...
                          <tr> 
                            <td width="64" class="list13_1">
								 <%	IF intCurPage >1 THEN
										Response.Write "<a href='admin_event_lotte.asp?intPage=" & intCurPage-1 & "'>◀ 이전</a>"
									ELSE
								...
								<%	FOR intI=intStartPage to intStartPage-1+intLimit
										Response.Write "<a href='admin_event_lotte.asp?intPage=" & intI & "'>" & intI & "</a> "
								...
								<%	IF intCurPage - intLastPage <0 THEN
										Response.Write "<a href='admin_event_lotte.asp?intPage=" & intCurpage+1 & "'>다음 ▶</a>"
									ELSE
