...
<% 
' ========================================================================================================
' 프로그램ID : Enter_Month_Total
' 업  무  명 : 수요예측
' 프로그램명 : 롯데월드 입장객 예측 - 월-전체
' 최초작성일 : 2002/10/16
' 최종작성일 : 2002/11/21
' 개  발  자 : 박순몽(kweather)
' ========================================================================================================
...
ArrQuery = array(varEnterType,"total") '쿼리 변수
  ...
  <tr> 
	...
	<!--큰 테이블 시작--> 
      <table width="642" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td align="left"><img src="../../enter/images/<% =FnChangeImage(varEnterType,"Month1") %>" width="200" height="21"></td>
        </tr>
        <tr valign="top"> 
          <td height="30"><img src="../../enter/images/title_bar.gif" width="642" height="5"></td>
        </tr>
        <tr> 
          <td>
		  <!--표 테이블 시작--> 
            <table width="642" border="0" cellspacing="1" cellpadding="7">
              ...
              <tr> 
			    ...
			    <% For intI=0 TO 2 %>
                <td class="list01_bg"><% =FnNumberFormat(rs("total")) %></td>
                <% rs.MOVENEXT : NEXT : rs.MOVEFIRST %>
              ...
              <tr> 
                ...
                <% rs.MOVENEXT : NEXT : rs.MOVEFIRST %>
                <td class="list04_bg"><% =FnNumberFormat(rssum("adult")) %></td>
              </tr>
              <tr> 
                <td class="list03_bg2">전년실적</td>
                <% For intI=0 TO 2 %>
                <td class="list01_bg2"><% =FnNumberFormat(rslast("adult")) %></td>
                <% rslast.MOVENEXT : NEXT : rslast.MOVEFIRST %>
                <td class="list04_bg2"><% =FnNumberFormat(rslastsum("adult")) %></td>
              </tr>
              <tr> 
                <td class="list03_bg">전년비</td>
                <% For intI=0 TO 2 %>
                <td class="list01_bg"><% =FnPercentFormat(rs("adult"),rslast("adult")) %></td>
                <% rs.MOVENEXT : rslast.MOVENEXT : NEXT : rs.MOVEFIRST : rslast.MOVEFIRST %>
                <td class="list04_bg"><% =FnPercentFormat(rssum("adult"),rslastsum("adult")) %></td>
              </tr>
              <tr align="center"> 
                <td colspan="6"><img src="../../enter/images/point_line3.gif" width="628" height="1"></td>
              </tr>
              <tr> 
                ...
                <td class="list03_bg">예측값</td>
                <% For intI=0 TO 2 %>
                <td class="list01_bg"><% =FnNumberFormat(rs("school")) %></td>
                <% rs.MOVENEXT : NEXT : rs.MOVEFIRST %>
                <td class="list04_bg"><% =FnNumberFormat(rssum("school")) %></td>
              </tr>
              <tr> 
                <td class="list03_bg2">전년실적</td>
                <% For intI=0 TO 2 %>
                ...
                <% rslast.MOVENEXT : NEXT : rslast.MOVEFIRST %>
                <td class="list04_bg2"><% =FnNumberFormat(rslastsum("school")) %></td>
              </tr>
              <tr> 
                <td class="list03_bg">전년비</td>
                <% For intI=0 TO 2 %>
                <td class="list01_bg"><% =FnPercentFormat(rs("school"),rslast("school")) %></td>
                <% rs.MOVENEXT : rslast.MOVENEXT : NEXT : rs.MOVEFIRST : rslast.MOVEFIRST %>
                <td class="list04_bg"><% =FnPercentFormat(rssum("school"),rslastsum("school")) %></td>
              </tr>
              <tr align="center"> 
                <td colspan="6"><img src="../../enter/images/point_line3.gif" width="628" height="1"></td>
              </tr>
              <tr> 
                ...
                <% rs.MOVENEXT : NEXT : rs.MOVEFIRST %>
                <td class="list04_bg"><% =FnNumberFormat(rssum("child")) %></td>
              </tr>
              <tr> 
                <td class="list03_bg2">전년실적</td>
                <% For intI=0 TO 2 %>
                <td class="list01_bg2"><% =FnNumberFormat(rslast("child")) %></td>
                <% rslast.MOVENEXT : NEXT : rslast.MOVEFIRST %>
                <td class="list04_bg2"><% =FnNumberFormat(rslastsum("child")) %></td>
              </tr>
              <tr> 
                <td class="list03_bg">전년비</td>
                <% For intI=0 TO 2 %>
                <td class="list01_bg"><% =FnPercentFormat(rs("child"),rslast("child")) %></td>
                <% rs.MOVENEXT : rslast.MOVENEXT : NEXT : rs.MOVEFIRST : rslast.MOVEFIRST %>
                <td class="list04_bg"><% =FnPercentFormat(rssum("child"),rslastsum("child")) %></td>
              </tr>
              <tr bgcolor="#B0DFFD"> 
        ...
        <tr>
		  ...
		  <!--하단 버튼 바 테이블 시작--> 
            <table width="642" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="637" align="right"><a href=../../enter/excel/Enter_month_total_excel.asp?varEnterType=<%=varEnterType%>><img border=0 src="../../enter/images/download_button.gif" width="88" height="26"></a></td>
                <td width="5"></td>
              </tr>
            </table>
			<!--하단 버튼 바 테이블 끝-->
