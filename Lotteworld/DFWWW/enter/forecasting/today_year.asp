...
'변수의 설정
Set objServer = Server.CreateObject("XTTodayYearMTS.clsXTTodayYearNTX")
  ...
  <tr> 
	...
	<!--큰 테이블 시작-->
      <table width="642" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td align="left"><img src="../../enter/images/title_today_year.gif" width="200" height="21"></td>
        </tr>
        <tr> 
