...
<% 
' ========================================================================================================
' 프로그램ID : TXBBULLETIN - lotte list
' 업  무  명 : 수요예측
' 프로그램명 : 롯데월드 입장객 예측 행사 - 롯데월드 리스트 보기
' 최초작성일 : 2002/10/16
' 최종작성일 : 2002/11/21
' 개  발  자 : 박순몽(kweather)
' ========================================================================================================
  ...
  <tr> 
	...
	<!--큰 테이블 시작--> 
      <table width="642" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td align="left" height="21"><img src="../../enter/images/title_event_lotte.gif" width="200" height="21"></td>
        </tr>
        <tr> 
          <td height="20" valign="top"><img src="../../enter/images/title_bar.gif" width="642" height="5"></td>
        </tr>
        <tr> 
          <td valign="top" height="70"><img src="../../enter/images/lotteworld3.gif" width="642" height="53"></td>
        </tr>
        <tr> 
          <td>
		  <!--게시판 목록 시작--> 
            ...
            <tr> 
                ...
                <td class="list05" width="417"><a href="event_lotte_view.asp?intIdx=<% =rs("IDX") %>" title="<% =rs("title") %>"><%=rs("title") %></a></td>
              ...
              <tr>
                ...
                <%	
					IF intCurPage >1 THEN '이전 페이지 결정
						Response.Write "<a href='event_lotte_list.asp?intPAGE=" & intCurPage-1 & "'>◀ 이전</a>"
					ELSE
                ...
                <td width="140" class="list14_1">
                  <div align="center">
                  <% 
					FOR intI=intStartPage to intStartPage-1+intLimit '각 페이지 번호 링크
							Response.Write "<a href='event_lotte_list.asp?intPAGE=" & intI & "'>" & intI & "</a>"
                ...
                <% 
					IF intCurPage - intLastPage < 0 THEN  '다음 페이지 결정
						Response.Write "<a href='event_lotte_list.asp?intPAGE=" & intCurPage+1 & "'>다음 ▶</a>"
					ELSE
