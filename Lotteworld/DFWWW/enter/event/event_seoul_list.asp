...
<% 
' ========================================================================================================
' 프로그램ID : TXBBULLETIN - seoul list
' 업  무  명 : 수요예측
' 프로그램명 : 롯데월드 입장객 예측 행사 - 서울랜드 리스트 보기
' 최초작성일 : 2002/10/16
' 최종작성일 : 2002/11/21
' 개  발  자 : 박순몽(kweather)
' ========================================================================================================
  ...
  <tr> 
	...
	<!--큰 테이블 시작-->
      <table width="642" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td valign="top" height="70"><img src="../../enter/images/seoulland3.gif" width="642" height="53"></td>
        </tr>
        <tr> 
          <td>
		  <!--게시판 목록--> 
            <table width="642" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                ...
                <td class="list05" width="417"><a href="event_seoul_view.asp?intIdx=<% =rs("IDX") %>" title='<% =rs("title") %>'><% =rs("title") %></a></td>
                ...
                <td width="64" class="list13_1">
					<% 
						IF intCurPage >1 THEN '이전 페이지 결정
							Response.Write "<a href='event_seoul_list.asp?intPAGE=" & intCurPage-1 & "'>◀ 이전</a>"
						ELSE
                  ...
                  <div align="center">   
					<% 
						FOR intI=intStartPage to intStartPage-1+intLimit '페이지 번호 링크
								Response.Write "<a href='event_seoul_list.asp?intPAGE=" & intI & "'>" & intI & "</a>"
                ...
                <td width="64" class="list13_2">
					<% 
						IF intCurPage - intLastPage <0 THEN '다음 페이지 결정
							Response.Write "<a href='event_seoul_list.asp?intPAGE=" & intCurPage+1 & "'>다음 ▶</a>"
						ELSE
