...
<% 
' ========================================================================================================
' 프로그램ID : TXBBULLETIN - lotte
' 업  무  명 : 수요예측
' 프로그램명 : 롯데월드 입장객 예측 행사 - 롯데월드 기사보기
' 최초작성일 : 2002/10/16
' 최종작성일 : 2002/11/13
' 개  발  자 : 박순몽(kweather)
' ========================================================================================================
...
ArrQuery = array("MQ",intIdx,"롯데월드") '보기 쿼리
        ...
        <tr> 
		  ...
		  <!--게시판 타이틀 시작-->
            <table width="600" border="0" cellspacing="0" cellpadding="0" height="19">
              <tr> 
                <td width="50" class="list10_1"><% =intIdx %></td>
        ...
        <tr> 
		  ...
		  <!--게시판 본문 시작-->
            <table width="600" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="list08"><% =FnContentType(rs("contents")) %></td>
              </tr>
            </table>
			<!--게시판 본문 끝-->
          </td>
		  ...
		  <!--하단 버튼 바 테이블 시작--> 
            <table width="642" border="0" cellspacing="0" cellpadding="0">
              <tr> 
			    ...
			    <td width="10"></td>
                <td width="76"><a href="event_lotte_list.asp"><img src="../../enter/images/listview_button.gif" width="76" height="26" border="0"></a></td>
                <td width="5"></td>
              </tr>
            </table>
			<!--하단 버튼 바 테이블 끝-->
