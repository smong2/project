...
Dim rs, IntI '포인트 예보 레코드셋, 증감변수
Dim varLocal '지역'

varLocal=Request.QueryString("varLocal")
IF varLocal="" THEN varLocal="서울/경기"
...
<!-- #include file="../../enter/script/FnWeather_Point.inc" -->
<html>
<head>
  ...
  <tr> 
	...
	<!-- 큰 테이블 시작-->
      <table width="642" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td align="left" height="21"><img src="../../enter/images/title_weather_point.gif" width="200" height="21"></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="10" class="list13_3"><img src="../../enter/images/graph.gif" width="12" height="6"> 온도 
            <img src="../../enter/images/graph2.gif" width="12" height="6"> 강수량</td>
        </tr>
        <tr> 
          <td>
		  <!--포인트예보 테이블 시작-->
            <table width="642" border="1" bordercolor="#dadada" cellspacing="0" cellpadding="4">
              <tr> 
                ...
                (<% =left(weekdayname(weekday(dateserial(left(rs("sdate"),4),mid(rs("sdate"),5,2),right(rs("sdate"),2)))),1) %>)</td>
              </tr>
              <tr class="list07_bg"> 
                <td>구분</td>
              ...
              <tr>
                ...
                <td class="list14_1" colspan="2"><% =rs("tempmax") %></td>
                <% rs.MOVENEXT : NEXT : FnMovingPointer %>
              </tr>
              <tr>                 
                <td class="list14_1" colspan="19">&nbsp;</td>
              </tr>
              <tr> 
                <td class="list13_bg2" rowspan="2">아이콘설명</td>
                <td class="table03"><img src="../../enter/images/s_icon01.gif" width="17" height="17"></td>
                <td class="table03" colspan="2"><img src="../../enter/images/s_icon02.gif" width="17" height="17"></td>
                <td class="table03" colspan="2"><img src="../../enter/images/s_icon03.gif" width="17" height="17"></td>
                <td class="table03"><img src="../../enter/images/s_icon04.gif" width="17" height="17"></td>
                <td class="table03"><img src="../../enter/images/s_icon05.gif" width="17" height="17"></td>
                <td class="table03"><img src="../../enter/images/s_icon06.gif" width="17" height="17"></td>
                <td class="table03"><img src="../../enter/images/s_icon07.gif" width="17" height="17"></td>
                <td class="table03" colspan="2"><img src="../../enter/images/s_icon08.gif" width="17" height="17"></td>
                <td class="table03" colspan="2"><img src="../../enter/images/s_icon09.gif" width="17" height="17"></td>
                <td class="table03" colspan="2"><img src="../../enter/images/s_icon10.gif" width="17" height="17"></td>
                <td class="table03" colspan="2"><img src="../../enter/images/s_icon11.gif" width="17" height="17"></td>
                <td class="table03"><img src="../../enter/images/s_icon12.gif" width="17" height="17"></td>
              </tr>
              <tr> 
