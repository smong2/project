...
IF varInsert="" AND varType<>"" THEN '모형 선택시 목록 불러온다
ArrQuery=array("Electric","View","월","2002","12","12",varType,"11", "1", "1")
...
ArrQuery=array("Electric","Insert",dtdate,intYear,intMonth,intDay, varModelType, varModelCode, IntInter1, IntInter2)
...
<script language="JavaScript" src=../../electric/script/FnAdminInter.js></script>
</head>

<body bgcolor="#F5F5F5" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<form method=post name=form action=admin_vari_inter.asp onsubmit=FnCheck()> 
  ...
  <tr> 
	...
	<!--큰 테이블 시작-->
      <table width="642" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td><img src="../../electric/images/title_vari_inter.gif" width="200" height="21"></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td align="right"> 
            ...
            <table width="642" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td class="title_01_r"><img src="../../electric/images/vermilion_buret.gif" width="7" height="7"> 
                  개입변수조회: 
        ...
        <tr> 
		  ...
		  <!--개입변수 박스 테두리 시작--> 
            <table border="0" cellspacing="0" cellpadding="0" width="642">
              ...
              <tr> 
                <td><img src="../../electric/images/gray_round_s_edge_left.gif" width="6" height="80"></td>
                <td class="table03"> 
                  <!--개입변수 입력 시작-->
                  <table width="480" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td width="4"></td>
                      <td class="title_01" width="110"><img src="../../electric/images/vermilion_triangle2.gif" width="5" height="9"> 
                        개입변수1 
                      ...
                      <td width="53"><input type=image src="../../electric/images/save.gif" width="53" height="26" border="0"></td>
                    </tr>
                  </table>
                  <!--개입변수 입력 끝-->
                </td>
                <td><img src="../../electric/images/gray_round_s_edge_right.gif" width="6" height="80"></td>
              </tr>
              <tr> 
