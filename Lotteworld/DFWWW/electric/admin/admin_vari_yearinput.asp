...
Dim intI '증감변수
Dim intYear '년
Dim lngPopNationalAdult,lngPopSeoulSchool,lngPopSeoulChild,PopMetropolisAdult '사용자 입력 값
...
<script language='javascript' src=../../electric/script/Fnadmin_vari_yearinput.js></script>
</head>
...
<form method=post name=form action=admin_vari_yearinput.asp onsubmit='return Fncheck()'>
  ...
  <tr> 
	...
	<!--큰 테이블 시작-->
      <table width="642" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td colspan="2"><img src="../../electric/images/title_vari_yearinput.gif" width="200" height="21"></td>
        </tr>
        <tr> 
		  ...
		  <!--변수입력 테이블 시작--> 
              <table width="642" border="0" cellspacing="1" cellpadding="7">
                ...
                <tr> 
                  ...
                  <td class="list01_bg3"> 
                    <input type="text" name="txtPopNationalAdult" size="20" maxlength="20" value=<% IF varView="ok" THEN Response.Write rs("PopNationalAdult") %>>
                    명</td>
                </tr>
                <tr> 
                  <td class="list15_bg3">수도권(서울,인천,경기) 성인추계인구 (20~39세)</td>
                  <td class="list01_bg3"> 
                    <input type="text" name="txtPopMetropolis" size="20" maxlength="20" value=<% IF varView="ok" THEN Response.Write rs("PopMetroPolisAdult") %>>
                    명</td>
                </tr>
                <tr> 
                  <td class="list15_bg3">서울 중고생추계인구 (15~19세)</td>
                  <td class="list01_bg3"> 
                    <input type="text" name="txtPopSeoulSchool" size="20" maxlength="20" value=<% IF varView="ok" THEN Response.Write rs("PopSeoulSchool") %>>
                    명 </td>
                </tr>
                <tr> 
                  <td class="list15_bg3">서울 어린이추계인구 (10~14세)</td>
                  <td class="list01_bg3"> 
                    <input type="text" name="txtPopSeoulChild" size="20" maxlength="20" value=<% IF varView="ok" THEN Response.Write rs("PopSeoulChild") %>>
                    명 </td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td class="list15_bg3">자이로드롭 영업여부</td>
                  <td class="list01_bg3"> 
                ...
                <tr> 
                  ...
                  <td class="list01_bg3"> 
                    <input type="text" name="txtGNI" size="20" maxlength="20" value=<% IF varView="ok" THEN Response.Write rs("GNI") %>>
                    10억원</td>
                </tr>
                <tr bgcolor="#CECFF5"> 
                  <td height="7" colspan="2"></td>
