...
<script language=javascript src="../../electric/script/FnAdminvariMonth.js"></script>
</head>
  ...
  <tr> 
	...
	<!--큰 테이블 시작-->
      <table width="642" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td colspan="2"><img src="../../electric/images/title_vari_monthinput.gif" width="200" height="21"></td>
        </tr>
        <tr> 
