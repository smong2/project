...
<body bgcolor="#F5F5F5" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('../../electric/images/map_today_on.gif','../../electric/images/map_tomorrow_on.gif')">
        ...
        <tr> 
          <td rowspan="2"> 
            ...
            <table width="290" border="0" cellspacing="0" cellpadding="0">
                ...
                <td height="29"> 
                  ...
                  <table width="290" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <td><a href="weather_main_tomorrow.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image82','','../../electric/images/map_tomorrow_on.gif',1)"><img name="Image82" border="0" src="../../electric/images/map_tomorrow.gif" width="98" height="23"></a></td>
                      <td><img src="../../electric/images/map_after_tomorrow_on.gif" width="96" height="23" alt=<% =rsland("sdate") %>></td>
                    </tr>
                  </table>
              ...
              <tr> 
                <td><img src="../../electric/images/afterto_national_map.gif" width="290" height="322"></td>
              </tr>
            </table>
