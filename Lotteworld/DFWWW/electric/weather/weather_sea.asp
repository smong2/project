...
Dim rstoday,rstomo,rsafterto '레코드셋 : 오늘 해상, 내일 해상, 모레 해상예보
Dim varLocal '지역'
  ...
  <tr> 
	...
	<!-- 큰 테이블 시작-->
      <table width="642" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td align="left" height="21"><img src="../../electric/images/title_weather_sea.gif" width="200" height="21"></td>
        </tr>
        <tr> 
          ...
          <td> 
            ...
            <table width="642" border="1" bordercolor="#dadada" cellspacing="0" cellpadding="7">
              ...
              <tr> 
                ...
                <td class="table03" colspan="2"><img src="../../electric/images/new<% =FnWeatherIcon(rstoday("overview")) %>.gif" width="34" height="34" alt='<% =rstoday("overview") %>'></td><% rstoday.MOVENEXT %>
                <td class="table03" colspan="2"><img src="../../electric/images/new<% =FnWeatherIcon(rstoday("overview")) %>.gif" width="34" height="34" alt='<% =rstoday("overview") %>'></td><% rstoday.MOVEFIRST %>
              </tr>
              <tr> 
              ...
              <tr> 
                ...
                <td class="list05_bg2">날씨</td>
                <td class="table03" colspan="2"><img src="../../electric/images/new<% =FnWeatherIcon(rstomo("overview")) %>.gif" width="34" height="34" alt='<% =rstomo("overview") %>'><% rstomo.MOVENEXT %></td>
                <td class="table03" colspan="2"><img src="../../electric/images/new<% =FnWeatherIcon(rstomo("overview")) %>.gif" width="34" height="34" alt='<% =rstomo("overview") %>'><% rstomo.MOVEFIRST %></td>
              </tr>
              <tr> 
                <td class="list05_bg2">풍향</td>
              ...
              <tr> 
                ...
                <td class="list05_bg2">날씨</td>
                <td class="table03" colspan="2"><img src="../../electric/images/new<% =FnWeatherIcon(rsafterto("overview")) %>.gif" width="34" height="34" alt='<% =rsafterto("overview") %>'><% rsafterto.MOVENEXT %></td>
                <td class="table03" colspan="2"><img src="../../electric/images/new<% =FnWeatherIcon(rsafterto("overview")) %>.gif" width="34" height="34" alt='<% =rsafterto("overview") %>'><% rsafterto.MOVEFIRST%></td>
              </tr>
              <tr> 
                <td class="list05_bg2">풍향</td>
          ...
          <td>
            <table width="642" border="1" bordercolor="#dadada" cellspacing="0" cellpadding="7">
              ...
              <tr> 
                <td class="list15_bg" rowspan="4"><% =right(rstoday("sdate"),2) %></td>
                <td class="list05_bg2">날씨</td>
                <td class="table03" colspan="2"><img src="../../electric/images/new<% =FnWeatherIcon(rstoday("overview")) %>.gif" width="34" height="34" alt='<% =rstoday("overview") %>'><% rstoday.MOVENEXT %></td>
                <td class="table03" colspan="2"><img src="../../electric/images/new<% =FnWeatherIcon(rstoday("overview")) %>.gif" width="34" height="34" alt='<% =rstoday("overview") %>'><% rstoday.MOVEFIRST%></td>
              </tr>
              <tr> 
                <td class="list05_bg2">풍향</td>
                <td class="list14_1"><% =rstoday("winddiram") %></td>
