...
<% 
' ========================================================================================================
' 프로그램ID : MAIN aftertomorrow
' 업  무  명 : 수요예측
' 프로그램명 : 롯데월드 전기 예측 메인 페이지 - 모레
' 최초작성일 : 2002/11/27
' 최종작성일 : 2002/11/27
' 개  발  자 : 박순몽(kweather)
' ========================================================================================================
...
Dim rs, rslast, rslastsum, rslastweek, rslastweeksum,rsland, rspoint '레코드셋 (전년동일,전년동일합계,전년동요일,전년동요일합계)
dim intI '증가변수

%>
<!-- #include file="../electric/script/FnSearch_Date.inc"-->
<%
ArrQuery = array("afterto",dtLastDay,dtLastWeekDay) '쿼리 변수
...
'여섯번째 레코드셋을 어레이로 변환
FnSplitRSArray arrRValue,rspoint,5
...
<body bgcolor="#F5F5F5" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('../electric/images/map_tomorrow_on.gif','../electric/images/map_after_tomorrow_on.gif','../electric/images/map_today_on.gif')">
<!--서울 레이어 시작-->
      ...
      <table width="642" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td rowspan="8"> 
            ...
            <table width="290" border="0" cellspacing="0" cellpadding="0">
                ...
                <td height="29"> 
                  ...
                  <table width="290" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <td><a href="main_tomorrow.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image144','','../electric/images/map_tomorrow_on.gif',1)"><img name="Image144" border="0" src="../electric/images/map_tomorrow.gif" width="98" height="23"></a></td>
                      <td><img src="../electric/images/map_after_tomorrow_on.gif" width="96" height="23"></td>
                    </tr>
                  </table>
              ...
              <tr> 
                <td><img src="../electric/images/after_tomorrow_map.gif" width="290" height="322"></td>
              </tr>
            </table>
        ...
        <tr> 
          <td height="26" background="../electric/images/temperature_bg.gif" class="list17_1" width="312">서울 
            <% =hour(time()) %>
            시 &nbsp; 
            <% =rspoint(hour(time())+25) %>
            ℃ &nbsp; 
            <% =FnWeatherCode(rspoint(hour(time()))) %>
          </td>
        </tr>
        <tr> 
          <td class="list14" height="187" width="312"> </td>
        </tr>
        <tr> 
          <td height="97"><img src="../electric/images/main_img.jpg" width="312" height="97"></td>
        </tr>
        <tr> 
          ...
          <td colspan="3"> 
            ...
            <table width="642" border="0" cellspacing="1" cellpadding="7">
              ...
              <tr> 
                ...
                <td class="list15_bg"><% =FnNumberFormat(rslast("total")) %></td>
              </tr>
              <tr> 
...
<U></U><!-- #include file="../electric/script/FnErrorCatch.inc"-->