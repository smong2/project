...
Dim rs, rslast, rslastsum, rslastweek, rslastweeksum, rsland,rsoverview,rspoint '레코드셋 (예측, 전년동일,전년동일합계,전년동요일,전년동요일합계,육상예보,기상개황)
dim intI '증가변수

%>
<!-- #include file="../electric/script/FnSearch_Date.inc"-->
<%
ArrQuery = array("today",dtLastDay,dtLastWeekDay) '쿼리 변수
        ...
        <tr> 
          <td rowspan="11"> 
            ...
            <table width="290" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="29"> 
                  ...
                  <table width="290" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td><img src="../electric/images/map_today_on.gif" width="96" height="23"></td>
                      <td><a href="main_tomorrow.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image127','','../electric/images/map_tomorrow_on.gif',1)"><img name="Image127" border="0" src="../electric/images/map_tomorrow.gif" width="98" height="23"></a></td>
                      <td><a href="main_afterto.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image128','','../electric/images/map_after_tomorrow_on.gif',1)"><img name="Image128" border="0" src="../electric/images/map_after_tomorrow.gif" width="96" height="23"></a></td>
                    </tr>
                  </table>
              ...
              <tr> 
                <td><img src="../electric/images/today_map.gif" width="290" height="322"></td>
              </tr>
            </table>
